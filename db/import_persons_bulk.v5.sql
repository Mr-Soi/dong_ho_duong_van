-- dọn staging
IF OBJECT_ID('dbo.StgPersons','U') IS NULL RAISERROR('StgPersons missing',16,1);
DELETE FROM dbo.StgPersons;
GO
-- BULK CSV (UTF-8, có quote, bỏ dòng tiêu đề)
...
GO
SELECT StgRows = COUNT(*) FROM dbo.StgPersons;
