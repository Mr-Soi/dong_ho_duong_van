...
BULK INSERT dbo.StgPosts (
  PostId,Title,Slug,Content,Summary,CategoryId,
  FeatureImageUrl,HeroImageUrl,ThumbnailUrl,
  Status,IsPublished,PublishDate,PublishTime,
  CreatedAt,CreatedBy,UpdatedBy,TitleNorm,SlugNorm
)
FROM '/tmp/Posts.utf8.csv'
WITH (FORMAT='CSV', FIRSTROW=2, FIELDQUOTE='\"', CODEPAGE='65001', KEEPNULLS, TABLOCK);
