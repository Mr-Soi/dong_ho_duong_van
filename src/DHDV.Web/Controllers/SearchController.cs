...
namespace DHDV.Web.Controllers
{
    ...
    public class SearchResultVM
    {
        ...
        public System.Collections.Generic.List<Hit> People { get; set; } = new();
        public System.Collections.Generic.List<Hit> Albums { get; set; } = new();
        public System.Collections.Generic.List<Hit> Posts  { get; set; } = new();
